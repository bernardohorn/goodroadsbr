...
import 'package:goodroadsbr/app.dart';
import 'package:goodroadsbr/core/di/providers.dart';
import 'package:shared_preferences/shared_preferences.dart';

/// `flutter_secure_storage` fala com o Keychain/Keystore via canal de
/// plataforma, que nao existe em `flutter test` (roda em Dart puro, sem
/// Android/iOS reais). Sem esse fake, a leitura do token nunca resolve, o
...
void main() {
  testWidgets('CitizenApp inicia na tela de login quando nao ha sessao salva', (tester) async {
